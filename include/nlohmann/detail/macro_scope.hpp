...
#if !defined(JSON_HAS_CPP_26) && !defined(JSON_HAS_CPP_23) &&                  \
    !defined(JSON_HAS_CPP_20) && !defined(JSON_HAS_CPP_17) &&                  \
...
#define NLOHMANN_DEFINE_TYPE_INTRUSIVE(Type, ...)                              \
  ...
  template <typename BasicJsonType,                                            \
            nlohmann::detail::enable_if_t<                                     \
                nlohmann::detail::is_basic_json<BasicJsonType>::value, int> =  \
                0>                                                             \
  friend void from_json(const BasicJsonType &nlohmann_json_j,                  \
